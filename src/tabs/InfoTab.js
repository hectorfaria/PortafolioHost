		...
		return (
			<main className="review">
				<div className="code-container">
					<span>
						Hi!, My name is Hector Faria, I'm a self-taught developer, I'm quite new in the development
						enviroment but I'm always willing to learn! , Interested in working with me?{' '}
